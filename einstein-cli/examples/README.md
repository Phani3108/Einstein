# Einstein CLI Examples

This directory contains example scripts and demonstrations of Einstein CLI functionality.
...
To run these examples, make sure you have the Einstein CLI dependencies installed:
