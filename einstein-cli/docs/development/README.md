...
This directory contains documentation and verification materials used during the development of Einstein CLI.
...
If you're a user of Einstein CLI, you probably want the main documentation in the parent `docs/` directory:
